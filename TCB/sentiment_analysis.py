...
def generate_news_score(news_description):
    prompt = f"""
        ...
        **Contextual Guidance**:  
        ...
        Analyze them carefully. Check whether the following keywords - "অনিয়ম, কেনাকাটা, পণ্য বিক্রয়, কার্ড বিতরণ, টিসিবি স্মার্ট ফ্যামিলি কার্ড, টিসিবি ভবন" are relevant to the news. 
...
def update_news_data(news_data, n):
    ...
    with open('dhakatribune_recent_tcb_data.json', 'w', encoding='utf-8') as file:
...
with open('dhakatribune_recent_tcb_data.json', 'r', encoding='utf-8') as file:
