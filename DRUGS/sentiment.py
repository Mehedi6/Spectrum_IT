...
def generate_news_score(news_description):
    prompt = f"""
        ...
        **Contextual Guidance**:  
        ...
        Analyze them carefully. Check whether the following keywords - "মাদক, মাদকদ্রব্য, যাবজ্জীবন, অবৈধ, চোরাচালান, হেরোইন, গাঁজা, ইয়াবা, নিষিদ্ধ, পাচার, আদালত, রায়, পুলিশ, মামলা, গ্রেপ্তার, বিচার, অপরাধ, সমাজ, যুবক, স্বাস্থ্য, সচেতনতা" are relevant to the news. 
        
        If these keywords are applicable but not included in {news_description['keywords']}, suggest additional keywords; otherwise, respond with **Keywords: <[]>**.
...
def update_news_data(news_data, n):
    ...
    with open('C:\\Users\\arwen\\Desktop\\Newspaper Scraping\\Spectrum_IT\\DRUGS\\drugs_data.json', 'w', encoding='utf-8') as file:
...
with open('C:\\Users\\arwen\\Desktop\\Newspaper Scraping\\Spectrum_IT\\DRUGS\\drugs_data.json', 'r', encoding='utf-8') as file:
