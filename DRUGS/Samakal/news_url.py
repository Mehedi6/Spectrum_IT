...
def scrape_links(output_file_name, urls_to_scrape):
        ...
        while True:
            try:
                ...
                see_more_button = wait.until(EC.element_to_be_clickable(
                    (By.XPATH, '/html/body/main/div/div/div/div/div[2]/div[2]/a')
                ))
                ...
                WebDriverWait(driver, 10).until(
                    EC.presence_of_element_located((By.XPATH, '/html/body/main/div/div/div/div/div[2]/div[1]/div/a'))
                )
                ...
                try:
                    ...
                    WebDriverWait(driver, 10).until(
                        EC.invisibility_of_element_located((By.CSS_SELECTOR, 'div.auto-load.text-center[style="display: none;"]'))
                    )
                    
                    time.sleep(5)  # Wait for more content to load
                    # Check if new content has been loaded
                    current_article_count = len(driver.find_elements(By.XPATH, '/html/body/main/div/div/div/div/div[2]/div[1]/div/a'))  # Replace with appropriate selector for articles
                    ...
                    if current_article_count == previous_article_count:
                        ...
                        for _ in range(num_clicks):
                            try:
                                ...
                                time.sleep(5)  # You can adjust the wait time as needed (or use WebDriverWait)
                                current_article_count = len(driver.find_elements(By.XPATH, '/html/body/main/div/div/div/div/div[2]/div[1]/div/a'))  # Replace with appropriate selector for articles
                                if current_article_count != previous_article_count:
    ...
    def extract_links():
        ...
        paths = ['/html/body/main/div/div/div/div/div[2]/div[1]/div/a',
                ]
...
# Example usage:
start_urls = [
    'https://samakal.com/topic/%E0%A6%AE%E0%A6%BE%E0%A6%A6%E0%A6%95'


]

scrape_links("C:\\Users\\arwen\\Desktop\\Newspaper Scraping\\Spectrum_IT\\DRUGS\\Samakal\\news_links.json", start_urls)
