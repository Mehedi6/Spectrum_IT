...
class NewsScraper:
    ...
    def parse_bengali_date(self, bengali_date_str):
        ...
        try:
            ...
            return datetime.strptime(english_date_str, "%I:%M %p, %d %B %Y")
    ...
    def scrape_news_data(self, url, news_type, sub_category):
        ...
        base_url = "https://www.jagonews24.com"  # Replace with the website's base URL
        try:
            image = soup.select_one('#main-content > section > div.container > div > div.col-sm-8.main-content.marginBottom20 > div.row.marginBottom20 > div > article > div.paddingTop10 > div > img')
        ...
        try:
            # Content
            content_elements = soup.select('#main-content > section > div.container > div > div.col-sm-8.main-content.marginBottom20 > div.row.marginBottom20 > div > article > div.content-details > p')
        ...
        # Author
        try:
            author = soup.select_one('#main-content > section > div.container > div > div.col-sm-8.main-content.marginBottom20 > div.row.marginBottom20 > div > article > div.padding15.box-white > blockquote > div > div.col-sm-8 > div > div.media-body > span > a.visible-print-view')
        ...
        try:
            ...
            published_date_element = soup.select_one('#main-content > section > div.container > div > div.col-sm-8.main-content.marginBottom20 > div.row.marginBottom20 > div > article > div.padding15.box-white > blockquote > div > div.col-sm-8 > div > div.media-body > span'
            )
...
# Main Script
try:
    with open("C:\\Users\\arwen\\Desktop\\Newspaper Scraping\\Spectrum_IT\\JagoNews24\\jagonews_data.json", 'r', encoding='utf-8') as file:
...
with open("C:\\Users\\arwen\\Desktop\\Newspaper Scraping\\Spectrum_IT\\JagoNews24\\news_links.json", 'r', encoding='utf-8') as file:
...
with open("C:\\Users\\arwen\\Desktop\\Newspaper Scraping\\Spectrum_IT\\JagoNews24\\jagonews_data.json", 'w', encoding='utf-8') as file:
