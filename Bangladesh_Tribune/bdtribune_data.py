...
class NewsScraper:
    ...
    def scrape_news_data(self, url, news_type, sub_category):
        ...
        try:
            # Content
            content_elements = soup.select('#widget_9947 > div > div > div.jw_content_detail_each.content_detail.detail > div.row.detail_holder > div > div > div.detail_inner > article > div.viewport.jw_article_body > p')
...
# Main Script
try:
    with open("C:\\Users\\arwen\\Desktop\\Newspaper Scraping\\Spectrum_IT\\Bangladesh_Tribune\\bdtribune_data.json", 'r', encoding='utf-8') as file:
...
with open("C:\\Users\\arwen\\Desktop\\Newspaper Scraping\\Spectrum_IT\\Bangladesh_Tribune\\news_links.json", 'r', encoding='utf-8') as file:
...
with open("C:\\Users\\arwen\\Desktop\\Newspaper Scraping\\Spectrum_IT\\Bangladesh_Tribune\\bdtribune_data.json", 'w', encoding='utf-8') as file:
